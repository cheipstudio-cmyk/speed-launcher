...
class SettingsRepository(context: Context) {
    ...
    // Compat: alcuni file vecchi possono ancora leggere showDock; ritorna sempre false
    ...
    fun setShowSearchBar(show: Boolean) {
        prefs.edit().putBoolean(KEY_SHOW_SEARCH, show).apply()
        showSearchBar.postValue(show)
    }
