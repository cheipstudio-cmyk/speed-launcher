...
/**
 * v52: Widget Speed Stats — versione hardened con try/catch su ogni system call,
 * così non crasha mai anche su device esotici.
 */
class SpeedStatsWidgetProvider : AppWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        for (id in ids) {
            try {
                ...
                // Anche se update fallisce, non crashare
            }
        }
    }
    ...
    private fun updateWidget(
        ...
        try {
            ...
            views.setProgressBar(R.id.ramProgress, 100, 0, false)
        }
        ...
        try {
            ...
            views.setProgressBar(R.id.storProgress, 100, 0, false)
        }
        ...
        try {
            ...
            views.setProgressBar(R.id.battProgress, 100, 0, false)
        }
